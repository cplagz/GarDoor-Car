...
- Male-to-female (and Male-to-male if you use HC-SR04 model and need to connect four components to 5v power) breadboard jumper wires (Dupont) - Breadboard 400 tie-point or larger
